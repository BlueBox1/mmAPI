...
namespace app_decode_client_sample_2
{
   ...
   {
      public static Int64 _SecondCounter = 0;
      public static double _VideoDuration = 0;
      public static uint _VideoWidth = 0;
      public static uint _VideoHeight = 0;
      public static uint _VideoFourCC = 0;
      public static double _VideoFPS = 0;
         ...
         try
         {
               ...
               (((uint)status & (uint)mmStatusBase.MM_STS_LIB_INFO_BASE) == (uint)mmStatusBase.MM_STS_LIB_INFO_BASE))
            {
               ...
               if (status == (uint)mmStatus.MM_STS_SRC_INFO_NO_NETWORK_FRAME_TIMEOUT)
               {
                  ...
                  MMSendMessage.SendWindowText(window.GetHWND(), msg, MMSendMessage.MM_WIN_TXT_FLAG.MM_STATUS | MMSendMessage.MM_WIN_TXT_FLAG.MM_WDOG);
               }
            }
                     ...
                     (((uint)status & (uint)mmStatusBase.MM_STS_LIB_WARNING_BASE) == (uint)mmStatusBase.MM_STS_LIB_WARNING_BASE))
            {
               ...
               {
                  // winsock connection errors considered useful information to the user
                  //MMInterop.SendWindowText(window.GetHWND(), msg, MMInterop.MM_WIN_TXT_FLAG.MM_STATUS);
               }
            }
